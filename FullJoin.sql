...
--Return all records when there is amatch in either left or right table .
SELECT testproduct_id,product_name,category_name FROM testproduct FULL JOIN categories
