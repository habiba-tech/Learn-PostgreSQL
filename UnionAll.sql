...
--UNION ALL :-
-- Its used to combine two or quries and returns all rows inculding duplicate 
--UNION ALL = COMBINE + KEEP DUPLICATE 

SELECT p_id , p_name FROM products
UNION ALL 
SELECT testproduct_id , product_name FROM testproduct ORDER BY p_id; 
